...
// // ANSWER:
// No, because we have given if condition, to run untill finds 4 then stop.
...
// ANSWER: The space complexity depends on the length of the string
